package cn.psvmc.zjfiledownload.service;
...
public class DownloadService extends Service {
    ...
    public static final String ACTION_DOWNLOAD_BROAD_CAST = "cn.psvmc.zjfiledownload:action_download_broad_cast";

    public static final String ACTION_DOWNLOAD = "cn.psvmc.zjfiledownload:action_download";

    public static final String ACTION_PAUSE = "cn.psvmc.zjfiledownload:action_pause";

    public static final String ACTION_CANCEL = "cn.psvmc.zjfiledownload:action_cancel";

    public static final String ACTION_PAUSE_ALL = "cn.psvmc.zjfiledownload:action_pause_all";

    public static final String ACTION_CANCEL_ALL = "cn.psvmc.zjfiledownload:action_cancel_all";
    ...
    private void download(final int position, final AppInfo appInfo, String tag) {
        final DownloadRequest request = new DownloadRequest.Builder()
                .setTitle(appInfo.getName() + "." + ZJFileUtils.getSuffix(appInfo.getUrl()))
    ...
    public static class DownloadCallBack implements CallBack {
        ...
        public void onProgress(long finished, long total, int progress) {
            ...
            mAppInfo.setDownloadPerSize(APPUtils.getDownloadPerSize(finished, total));
